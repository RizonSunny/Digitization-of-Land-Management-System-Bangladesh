  ...
  <div class="column" >
    <div class="card" >
      <div class="container" >
        ...
        <br>
        <form><button class="button" type="submit"  style="color:yellow" >as owner </button></form>
        <br>
      </div>
    </div>
  </div>
...
<form method="post" action="insertlandownerpublicadmin1">
  @csrf
  <input type="hidden" name="lid" value="{{ $lid }}">
<div class="form-style-10">
    <div class="section"><span>5</span><b>Public Organization Information</b></div>
...
<div class="container" style="margin-left:10px;margin-top:20px;">
  ...
  {{$lid}}
    ...
    <br>
  	<input required autofocus  id="org" type="text" name="org_name" >
  	<br><br>
  	<label>Inistitution No</label>
    <br>
  	<input required autofocus id="in"  type="text" name="in_no" >
  	<br><br>
