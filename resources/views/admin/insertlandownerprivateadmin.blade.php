  ...
  <div class="column" >
    <div class="card" >
      <div class="container" >
        ...
        <br>
        <form><button class="button" type="submit"  >as owner </button></form>
        <br>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <div class="container">
        ...
        <br>
        <form><button class="button" type="submit"  style="color:yellow" > as owner </button></form><br>
      </div>
    </div>
  </div>
  <div class="column">
    <div class="card">
      <div class="container">
        ...
        <br>
        <form><button class="button" type="submit" >as owner</button></form><br>
      </div>
    </div>
  </div>
</div>
...
<div>
<form method="post" action="insertlandownerprivateadmin1">
  @csrf
  <input type="hidden" name="lid" value="{{ $lid }}">
<div class="form-style-10">
    <div class="section"><span>5</span><b>Private Organization Information</b></div>
    <script>
    $(document).ready(function() {
      $("#in").change(function() {
        var selection1 = document.getElementById('org').value;
        var selection2 = document.getElementById('in').value;
        $.post('orgpriv',{
          ...
          //  alert(jsondata['thana'].length);
            ...
            {
              alert('Organization Not Available');
...
<br>
<input required autofocus  id="org" type="text1" name="org_name" >
<br><br>
<label>Inistitution No</label>
<br>
<input required autofocus id="in" type="text1" name="in_no" >
<br><br>
