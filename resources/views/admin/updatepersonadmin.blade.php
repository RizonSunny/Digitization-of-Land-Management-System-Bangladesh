...
<h1 style="text-align:center;">Update Person</h1>

  <form method="post" action="updatepersonadmin">
    @csrf
...
<div class="container" style="margin-left:10px;margin-top:20px;">
      ...
      <label>name</label>
      <input required autofocus  type="text1" name="name" >
<br><br>
...
<br><br>
      <label>email </label>
      <input required autofocus  type="text1" name="email" >
    <br><br>
