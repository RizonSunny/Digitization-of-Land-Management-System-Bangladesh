...
<h1 style="text-align:center;">Insert Public Organization</h1>

  <form method="post" action="insertpublicorgadmin">
    @csrf


<!-- 2nd container land information-->
<div class="form-style-10">
    <div class="section"><span></span><b>Public Organization Information</b></div>
