...
<div>
<form method="post" action="insertlandownerpersonadmin1">
  @csrf
  <input type="hidden" name="lid" value="{{ $lid }}">
<div class="form-style-10">
    <div class="section"><span>5</span><b>Person Information</b></div>
...
{{$lid}}
    <label>NID</label>
    <br>
    <input required autofocus  id="in" type="text" name="nid" >
    <br><br>
    <label>Percentage Of Land</label>
    <br>
    <input required autofocus  type="text" name="percentage_of_land" >
    <br><br>
