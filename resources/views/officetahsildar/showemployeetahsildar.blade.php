...
<h5  style="margin-left:300px"> Tahsildar Office Employee</h5>
  ...
  @foreach($emps as $emp)
    ...
    <tr>
      ...
      <td> <form method="post" action="showemployeeacland">@csrf <button type="submit" name="nid" value="{{$emp->nid}}">details</button></form></td>
